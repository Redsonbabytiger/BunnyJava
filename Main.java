...
public class Main {
    ...
    SwingUtilities.invokeLater(() -> {
        ...
        final Font btnFont = new Font("Arial", Font.PLAIN, 16);
        ...
        bunnyGameBtn.setBounds(50, 80, btnWidth, btnHeight);
        bunnyGameBtn.setFont(btnFont);
        bunnyGameBtn.setToolTipText("Play the original BunnyGame");
        ...
        bunnyLevel2Btn.setBounds(250, 80, btnWidth, btnHeight);
        bunnyLevel2Btn.setFont(btnFont);
        bunnyLevel2Btn.setToolTipText("Play BunnyGame Level 2");
        ...
        boxShooterBtn.setBounds(150, 160, 200, btnHeight);
        boxShooterBtn.setFont(btnFont);
        boxShooterBtn.setToolTipText("Play Box Shooter Game");
